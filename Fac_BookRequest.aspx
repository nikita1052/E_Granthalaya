<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.Master" AutoEventWireup="true" CodeBehind="Fac_BookRequest.aspx.cs" Inherits="E_Granthalaya.Fac_BookRequest" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script>
        function showPopup(index) {
            var row = document.getElementById("GridView1").rows[index];
            var gridView = document.getElementById("GridView1");
            if (gridView != null && gridView.rows.length > 0) {
                var bookId = row.cells[2].innerText;
                var bookName = row.cells[3].innerText;

                $('#<%= lblbookid.ClientID %>').text(bookId);
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body" style="font-weight: 500">
                                    <div class="container-fluid">
                                        ...
                                        <div class="form-group mb-1">
                                            <asp:Label ID="Label5" runat="server" Font-Bold="true" Text="Book Status : "></asp:Label>
                                        ...
                                        <div class="form-group mb-1">
                                            <div class="alert alert-info d-flex align-items-center" role="alert">
                                                ...
                                                <div style="margin-left: 10px;">
                                                    <asp:Label ID="lbl_information" runat="server" Text="" CssClass="col-form-label" Font-Bold="true" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="modal-footer">
                                    <asp:LinkButton ID="btn_save" CssClass="btn btn-primary" runat="server" Text="Request Book" OnClick="btn_saveClick"></asp:LinkButton>
                    ...
                    <div class="card">
                        <div class="card-body" style="font-weight: 500">
                            ...
                            <asp:Panel ID="pnl_cat" runat="server" Visible="false">
                                <div class="row form-group mb-2">
                                    <asp:Label ID="lable1" runat="server" class="col-md-1 col-form-label">Category:<span class="text-danger">*</span></asp:Label>
                                    <div class="col-md-4">
                                        <asp:DropDownList ID="ddl_category" style="font-weight: 500" CssClass="form-control form-select" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddl_category_SelectedIndexChanged"></asp:DropDownList>
                                    </div>
                                </div>
                                </asp:Panel>
                            <div class="row form-group mb-2">
                            ...
                            <asp:Panel ID="pnl_card" runat="server" Visible="false" CssClass="scrollable-panel">
                                <div class="card p-2">
                                    <div class="row">

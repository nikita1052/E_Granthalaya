<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VerifyOTP.aspx.cs" Inherits="E_Granthalaya.VerifyOTP" %>
...
<head runat="server">
    ...
    <title>Verify OTP - E-Granthalaya v.1.0</title>
            ...
            <div class="card-body">
                <form runat="server" id="formlogin">
                    ...
                    <div class="form-group">
                        ...
                        <asp:TextBox ID="txt_otp" runat="server" CssClass="form-control" AutoComplete="off" Style="font-weight: 600" placeholder="Enter Verification Code"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rqr_otp" runat="server" ErrorMessage="Enter Valid OTP" ControlToValidate="txt_otp" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
                    </div>
                    <asp:Button ID="btn_verify" OnClick="btn_verify_Click" runat="server" Font-Bold="true" BackColor="#003da3" Text="Verify OTP" CssClass="btn btn-primary btn-block" />
